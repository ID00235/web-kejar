...
<b>{{$permohonan->nama_pemohon}}</b>, <br>
...
<blockquote>
Tanggal Pengajuan:  {{tanggal_indo2($permohonan->tanggal)}} <br>
...
<span style="border-radius: 3px; background: #bb6c62; text-align: center;" class="button-td">
    <a href="{{$url_detail}}" style="background: #1bbcc2; border: 15px solid #1bbcc2; font-family: sans-serif; font-size: 12px; line-height: 0.5; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
