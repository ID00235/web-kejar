        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 10px; padding-bottom:30px;  font-family: sans-serif; font-size: 15px; line-height: 20px; color: #333;">
                    <h2>Permohonan Informasi Anda <span style="color:#ef5555;"> Ditolak </span></h2>
                    <p style="color:#000 !important;">
                    {{$permohonan->nama_pemohon}}, Mohon maaf permohonan informasi anda dengan nomor #{{$permohonan->nomor}} tanggal {{tanggal_indo2($permohonan->tanggal)}}  tidak bisa kami proses dengan alasan sebagai berikut:
                    </p>
                    <blockquote>
