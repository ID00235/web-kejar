        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="{{URL::to("admin/berita/")}}" data-rel="reload" class="btn btn-outline btn-default btn-sm"><i class="fa fa-angle-left"></i> Index Berita</a>
                </div>
            </div>
            ...
            ?>
                <form action="{{URL::to('admin/berita/update/'.Crypt::encrypt($record->id))}}" method="POST"  enctype="multipart/form-data">
                        {{csrf_field()}}
                        <fieldset>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class = "thumbnail">
                                     <img width="100%" src = "{{asset('berita/thumb.'.$record->gambar)}}" class="img-responsive">
                                </div>
