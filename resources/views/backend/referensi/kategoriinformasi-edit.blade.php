...
@section('content')
	<?php
		$dataform = array("id"=>Crypt::encrypt($kategoriinformasi->id),
        ...
        <div class="col-md-12">
            <div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title"><i class="fa fa-pencil"></i> Edit Kategori Informasi</div>
  				...
  				<div class="panel-body">
  					<form action="{{URL::to('admin/referensi/kategoriinformasi/update')}}" method="post">
  						{{csrf_field()}}
						...
						<fieldset>
							<div class="form-group @if($errors->has('nama')) has-error @endif">
								...
								<input class="form-control" name="nama" placeholder="Masukan Nama Kategori Informasi" 
