        ...
        <div class="col-md-12">
            <div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title"><i class="fa fa-plus"></i> Tambah Alasan Keberatan Atas Informasi</div>
  				...
  				<div class="panel-body">
  					<form action="{{URL::to('admin/referensi/alasankeberatan/insert')}}" method="post">
  						{{csrf_field()}}
						<fieldset>
							<div class="form-group @if($errors->has('nama')) has-error @endif">
								<label>Nama</label>
								@if($errors->has('nama')) <small class="text-danger"><br>{{$errors->first('nama')}}</small> @endif
								<input class="form-control" name="nama" placeholder="Masukan Nama Alasan Keberatan" type="text">
							</div>
						</fieldset>
						<div>
