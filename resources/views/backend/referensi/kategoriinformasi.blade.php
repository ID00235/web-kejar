...
@section('content')
            ...
            <div class="content-box-large">
  				<div class="panel-heading">
					...
					<div class="panel-options">
						<a href="{{URL::to("admin/referensi/kategoriinformasi/create")}}" data-rel="reload" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Buat Baru</a>
					</div>
				</div>
  				<div class="panel-body">
		              ...
		              <tbody>
		              	<?php
		                	$no=0;
		                ?>
		                @foreach($kategoriinformasi as $jn)
		                <?php
		                	$no++;
		                	$id = $jn->id;
		                ...
		                ?>
		                	<tr>
		                		...
		                		<td>{{$nama}}</td>
		                		<td align="center">
		                			<a href="{{URL::to("admin/referensi/kategoriinformasi/edit/$cid")}}" class="btn btn-xs btn-success" title="Edit"><i class="fa fa-pencil"></i></a>
		                			@if($jdk>0)
    ...
    <form action="{{URL::to('admin/referensi/kategoriinformasi/delete')}}" method="post" id="form-delete">
