        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="{{URL::to("admin/informasi")}}" data-rel="reload" class="btn btn-default btn-sm btn-outline"><i class="fa fa-angle-left"></i> Ke Index Halaman</a>
                  <a href="{{URL::to("admin/informasi/edit/".$informasi->gethashid())}}" data-rel="reload" class="btn btn-success btn-sm  btn-outline"><i class="fa fa-pencil"></i> Edit</a>
                </div>
            </div>
