...
<div class="row">
    <div class="col-md-12">
        <div class="content-box-large">
            ...
            <a href="{{URL::to("admin/kelurahan/baru")}}" data-rel="reload" class="btn btn-primary btn-outline btn-sm"><i class="fa fa-plus"></i> Halaman Baru</a>
                <table id="tabel1" class="table table-striped table-condensed table-hover">
		              ...
		              <?php $no=0;?>
		              		@foreach($kelurahan as $row)
		              			...
		              			<tr>
		              				<td>{{$no}}</td>
		              				<td><a href="{{URL::to('admin/kelurahan/detail/'.$row->gethashid())}}" class="big2">{{$row->nama}}</a></td>
		              				<td>
		              					<a href="{{URL::to("admin/kelurahan/edit/".$row->gethashid())}}" class="btn btn-sm  btn-outline btn-success" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
...
<form action="{{URL::to('admin/kelurahan/delete')}}" method="post" id="form-delete">
    {{csrf_field()}}
