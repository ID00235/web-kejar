        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="{{URL::to("admin/header/baru")}}" data-rel="reload" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Upload Baru</a>
                </div>
            </div>
		              ...
		              <?php $no=0;?>
		              	...
		              	<?php $no++;?>
		              		<tr>
		              			...
		              			<td align="right">
		              				<a href="#" 
		                			data-image="{{$row->gambar}}" 
		                			data-nama = "{{$row->nama}}"
		                			data-kutipan = "{{$row->kutipan}}"
...
<!-- Modal EDIT -->
<form action="{{URL::to('admin/header/update')}}" method="POST" enctype="multipart/form-data">
	        		...
	        		<div class="col-md-12">
	                    ...
	                    <div class="col-md-12">
	                        <div class="form-group">
	                            <label>Ganti Gambar (<small>Resolusi yang disarankan 1360x240 Ukuran Max 1M Pixel</small>)</label>
...
<form action="{{URL::to('admin/header/delete')}}" method="post" id="form-delete">
    {{csrf_field()}}
    <input type="hidden" name="post_id"  id="post_id">
</form>

<form action="{{URL::to('admin/header/toggle/aktif')}}" method="post" id="form-aktif">
    {{csrf_field()}}
...
<script type="text/javascript">
	$(function(){
        ...
        $(".btn-preview").on("click",function(){
	     	var gambar = "{{URL::to('header')}}/" + $(this).attr('data-image');
