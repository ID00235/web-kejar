            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div id="photo" class="tab-pane fade in active">
                        <br>
                        <span class="btn btn-primary btn-outline btn-sm" id="tambah-photo"><i class="fa fa-plus-circle"></i> Tambah Photo Baru</span>
                        <hr>
                        <div id="list-photo">
...
<form action="{{URL::to('admin/gallery/delete-photo')}}" method="post" id="form-delete">
    {{csrf_field()}}
    <input type="hidden" name="post_id" id="post_id">
</form>

<form action="{{URL::to('admin/gallery/delete-video')}}" method="post" id="form-delete">
    {{csrf_field()}}
    <input type="hidden" name="post_id" id="post_id">
</form>
...
<script type="text/javascript">
    $(function() {
        var base_gallery = "{{URL::to('gallery/photo')}}/";
        ...
        var getlistphoto = function(page = 0) {
            $("#post-loader").fadeIn()
            $("#list-photo").load("{{URL::to('admin/gallery/list-photo').'?page='}}" + page,
                function() {
                    $("#post-loader").fadeOut();
                    callback_photo();
                });
        ...
        var callback_photo = function() {
            ...
            $(".btn-edit-photo").on("click", function(e) {
                ...
                $(".input-photo").val('');
                $.get("{{URL::to('admin/gallery/detailphoto/')}}" + '/' + id, function(respon) {
                    if (respon.status) {
        ...
        var getlistvideo = function(page = 0) {
            $("#post-loader").fadeIn()
            $("#list-video").load("{{URL::to('admin/gallery/list-video').'?page='}}" + page,
                function() {
                    $("#post-loader").fadeOut();
                    callback_video();
                });
        ...
        var callback_video = function() {
            ...
            $(".btn-edit-video").on("click", function(e) {
                ...
                var id = ($(this).attr('data-id'));
                $(".input-photo").val('');
                $.get("{{URL::to('admin/gallery/detailvideo/')}}" + '/' + id, function(respon) {
                    if (respon.status) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="body-detail">
                <form action="{{URL::to('admin/gallery/storephoto')}}" id="form-store-photo" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                    {{csrf_field()}}
...
<div class="modal fade" id="md-edit-photo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="body-detail">
                <form action="{{URL::to('admin/gallery/updatephoto')}}" id="form-update-photo" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                    {{csrf_field()}}
                    <div class="form-group">
                        <div class="col-md-12">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success  btn-outline" id="submit-update-photo"><i class="fa fa-save"></i> Simpan</button>
...
<form action="{{URL::to('admin/gallery/deletephoto')}}" id="form-delete-photo" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
    {{csrf_field()}}
...
<div class="modal fade" id="md-add-youtube" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="body-detail">
                <form action="{{URL::to('admin/gallery/storevideo')}}" id="form-store-video" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                    {{csrf_field()}}
                    <div class="form-group">
                        <div class="col-md-12">
...
<div class="modal fade" id="md-edit-youtube" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="body-detail">
                <form action="{{URL::to('admin/gallery/updatevideo')}}" id="form-update-video" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                    {{csrf_field()}}
...
<form action="{{URL::to('admin/gallery/deletevideo')}}" id="form-delete-video" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
    {{csrf_field()}}
