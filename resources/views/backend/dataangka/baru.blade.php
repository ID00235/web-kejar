        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="{{URL::to("admin/dataangka/")}}" data-rel="reload" class="btn btn-outline btn-default btn-sm"><i class="fa fa-angle-left"></i> Kembali Ke Index Halaman</a>
                </div>
            </div>
            ...
            ?>
                <form action="{{URL::to('admin/dataangka/store')}}" method="POST">
                        {{csrf_field()}}
                        <fieldset>
                            <div class="col-md-12">
