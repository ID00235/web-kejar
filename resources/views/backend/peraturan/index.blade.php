    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Upload Peraturan</div>
            </div>
            <div class="panel-body">
            <a href="{{URL::to("admin/peraturan/baru")}}" data-rel="reload" class="btn btn-primary btn-outline btn-sm"><i class="fa fa-plus"></i> Halaman Baru</a>
                  ...
                  <?php $no=0;?>
                      @foreach($peraturan as $row)
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{URL::to("admin/peraturan/edit/".$row->gethashid())}}" class="btn btn-sm  btn-outline btn-success" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
...
<form action="{{URL::to('admin/peraturan/delete')}}" method="post" id="form-delete">
    {{csrf_field()}}
  ...
  $(function(){
    ...
    $(".btn-del").on("click",function(){
        ...
        $("#post_id").val(post_id);
            ...
            bootbox.confirm({
            message: "Anda Yakin Ingin Menghapus Peraturan: <br><strong>" + nama + "</strong>",
            buttons: {
                confirm: {
                    label: 'Ya, Hapus',
