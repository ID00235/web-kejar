    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Halaman Organisasi Kejaksaan Negeri Batanghari</div>
            </div>
            <div class="panel-body">
            <a href="{{URL::to("admin/organisasi/baru")}}" data-rel="reload" class="btn btn-primary btn-outline btn-sm"><i class="fa fa-plus"></i> Halaman Baru</a>
                <table id="tabel1" class="table table-striped table-condensed table-hover">
                  ...
                  <?php $no=0;?>
                      @foreach($organisasi as $row)
                        ...
                        <tr>
                          <td>{{$no}}</td>
                          <td><a href="{{URL::to('admin/organisasi/detail/'.$row->gethashid())}}" class="big2">{{$row->nama}}</a></td>
                          <td>
                            <a href="{{URL::to("admin/organisasi/edit/".$row->gethashid())}}" class="btn btn-sm  btn-outline btn-success" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
...
<form action="{{URL::to('admin/organisasi/delete')}}" method="post" id="form-delete">
    {{csrf_field()}}
