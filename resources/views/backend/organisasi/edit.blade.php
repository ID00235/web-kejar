    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Edit Organisasi</div>
                <div class="panel-options">
                  <a href="{{URL::to("admin/organisasi/")}}" data-rel="reload" class="btn btn-outline btn-default btn-sm"><i class="fa fa-angle-left"></i> Kembali Ke Index </a>
                </div>
            </div>
            ...
            ?>
                ...
                <form action="{{URL::to('admin/organisasi/update/'.Crypt::encrypt($record->id))}}" method="POST">
                        {{csrf_field()}}
                        <fieldset>
                            <div class="col-md-12">
