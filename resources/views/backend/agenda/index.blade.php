...
<form action="{{URL::to('admin/agenda/delete-agenda')}}" method="post" id="form-delete">
    {{csrf_field()}}
    <input type="hidden" name="post_id" id="post_id">
</form>

<form action="{{URL::to('admin/agenda/delete-video')}}" method="post" id="form-delete">
    {{csrf_field()}}
    <input type="hidden" name="post_id" id="post_id">
</form>
...
<script type="text/javascript">
    $(function() {
        var base_gallery = "{{URL::to('gallery/agenda')}}/";
        ...
        var getlistagenda = function(page = 0) {
            $("#post-loader").fadeIn()
            $("#list-agenda").load("{{URL::to('admin/agenda/list-agenda').'?page='}}" + page,
                function() {
                    $("#post-loader").fadeOut();
                    callback_agenda();
                });
        ...
        var callback_agenda = function() {
            ...
            $(".btn-delete-agenda").on("click", function() {
                ...
                $.get("{{URL::to('admin/agenda/detail/')}}" + '/' + id, function(respon) {
                    if (respon.status) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="body-detail">
                <form action="{{URL::to('admin/agenda/store')}}" id="form-store-agenda" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                    {{csrf_field()}}
...
<div class="modal fade" id="md-edit-agenda" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="body-detail">
                <form action="{{URL::to('admin/agenda/update')}}" id="form-update-agenda" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                    {{csrf_field()}}
                    <div class="form-group">
                        <div class="col-md-12">
...
<form action="{{URL::to('admin/agenda/delete')}}" id="form-delete-agenda" data-parsley-validate="" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
    {{csrf_field()}}
