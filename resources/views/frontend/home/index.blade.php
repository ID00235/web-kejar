      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-3 col-xs-12 hidden-xs">
                <img class="img img-responsive" src="{{asset('images/pimda.png')}}" >
                <p class="hidden-xs">&nbsp;</p>
                <div class="sidemenu">
                    <p class="sidetitle">
                      <center><img src="{{asset('images/menu1.png')}}"  class="hidden-xs"></center>
                    </p>
                ...
                <div class="sidemenu">
                    <p class="sidetitle">
                      <center><img src="{{asset('images/menu2.png')}}"  class="hidden-xs"></center>
                    </p>
              ...
              <div class="col-lg-3 col-xs-12 hidden-lg hidden-md">
                <img class="img img-responsive  hidden-xs" src="{{asset('images/pimda.png')}}" >
                <p class="hidden-xs">&nbsp;</p>
                <div class="sidemenu">
                    <p class="sidetitle">
                      <center><img src="{{asset('images/menu1.png')}}"  class="hidden-xs"></center>
