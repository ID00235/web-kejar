...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="content-box-footer">
            <a href="<?php echo e(URL::to('admin/dataangka/')); ?>" class="btn btn-outline  btn-sm btn-default"><i class="fa fa-arrow-circle-right"></i> Lihat Detail</a>
            <span class="badge badge-white pull-right"><?php echo e($n_dataangka); ?></span>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="content-box-footer">
            <a href="<?php echo e(URL::to('admin/profil/')); ?>" class="btn btn-sm btn-outline btn-default"><i class="fa fa-arrow-circle-right"></i> Lihat Detail</a>
            <span class="badge badge-white pull-right"><?php echo e($n_dataangka); ?></span>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="content-box-footer">
            ...
            <span class="badge badge-white pull-right"><?php echo e($n_agenda); ?></span>
        </div>
    </div>
</div>
