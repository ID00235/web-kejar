        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/informasi/")); ?>" data-rel="reload" class="btn btn-outline btn-default btn-sm"><i class="fa fa-angle-left"></i> Kembali Ke Index </a>
                </div>
            </div>
            ...
            ?>
                ...
                <form action="<?php echo e(URL::to('admin/informasi/update/'.Crypt::encrypt($record->id))); ?>" method="POST">
