        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/support/baru")); ?>" data-rel="reload" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Upload Baru</a>
                </div>
            </div>
...
<!-- Modal -->
<form action="<?php echo e(URL::to('admin/support/update')); ?>" method="POST" >
...
<form action="<?php echo e(URL::to('admin/support/delete')); ?>" method="post" id="form-delete">
    <?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
	$(function(){
         ...
         var datatabel1 = $('#tabel1').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(URL::to('admin/support/datatable')); ?>",
            "aoColumns": [
