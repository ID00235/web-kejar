    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Halaman Profil Kecamatan</div>
            </div>
            <div class="panel-body">
            <a href="<?php echo e(URL::to("admin/profil/baru")); ?>" data-rel="reload" class="btn btn-primary btn-outline btn-sm"><i class="fa fa-plus"></i> Halaman Baru</a>
                <table id="tabel1" class="table table-striped table-condensed table-hover">
		              ...
		              <?php $no=0;?>
		              		<?php foreach($profil as $row): ?>
		              			...
		              			<tr>
		              				<td><?php echo e($no); ?></td>
		              				<td><a href="<?php echo e(URL::to('admin/profil/detail/'.$row->gethashid())); ?>" class="big2"><?php echo e($row->nama); ?></a></td>
		              				<td>
		              					<a href="<?php echo e(URL::to("admin/profil/edit/".$row->gethashid())); ?>" class="btn btn-sm  btn-outline btn-success" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
...
<form action="<?php echo e(URL::to('admin/profil/delete')); ?>" method="post" id="form-delete">
