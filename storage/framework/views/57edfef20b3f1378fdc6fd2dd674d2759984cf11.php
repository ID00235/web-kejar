    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title"><i class="fa fa-plus"></i> Entri Berita PPID</div>
            ...
            ?>
                <form action="<?php echo e(URL::to('admin/berita/store')); ?>" method="POST" enctype="multipart/form-data">
