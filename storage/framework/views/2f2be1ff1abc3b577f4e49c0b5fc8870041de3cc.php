    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title"><i class="fa fa-newspaper-o"></i> Edit Berita</div>
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/berita/")); ?>" data-rel="reload" class="btn btn-default btn-sm"><i class="fa fa-angle-left"></i> Index Berita</a>
                </div>
            </div>
            ...
            <?php
                ...
                $tanggal = old('tanggal') ? old('tanggal'):tanggalIndo($record->tanggal);
                $title_gambar = old('title_gambar') ? old('title_gambar'):$record->title_gambar;
            ?>
                <form action="<?php echo e(URL::to('admin/berita/update/'.Crypt::encrypt($record->id))); ?>" method="POST"  enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="col-md-6">
                                <div class = "thumbnail">
                                     <img width="100%" src = "<?php echo e(asset('berita/thumb.'.$record->gambar)); ?>" class="img-responsive">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?php if($errors->has('gambar')): ?> has-error <?php endif; ?>">
                                    <label>Ganti Gambar (<small>Resolusi disarankan 600x400 pixel</small>)</label>
