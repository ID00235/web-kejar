<?php $__env->startSection("pagetitle","Profil Kecamatan"); ?>
<?php $__env->startSection("subpage","Profil Kecamatan Batin XXIV"); ?>
        ...
        <div class="col-md-7">
            <div class="blog-post gallery-post">
                  <div class="post-title">
                      <h3 class=""><a href="<?php echo e(Request::url()); ?>"><span><?php echo e($profil->nama); ?></span></a></h3>
                  </div>
                  <div class="post-isi">
                      <?php echo $profil->isi;?>
                  </div>
