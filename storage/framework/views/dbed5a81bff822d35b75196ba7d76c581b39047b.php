                        ...
                        <fieldset>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Kutipan</label>
                                    <input class="form-control" name="kutipan"  value="<?php echo e($kutipan); ?>" placeholder="Kutipan" type="text">
                                </div>
                            </div>   
                            <div class="col-md-12">
                                <div class="form-group <?php if($errors->has('file')): ?> has-error <?php endif; ?>">
                                    <label>Pilih File Gambar (<small>Resolusi yang disarankan 1360x480 Pixel Ukuran Max 1M</small>)</label>
