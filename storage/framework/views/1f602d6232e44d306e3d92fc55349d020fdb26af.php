        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/dataangka")); ?>" data-rel="reload" class="btn btn-default btn-sm btn-outline"><i class="fa fa-angle-left"></i> Ke Index Halaman</a>
                  <a href="<?php echo e(URL::to("admin/dataangka/edit/".$dataangka->gethashid())); ?>" data-rel="reload" class="btn btn-success btn-sm  btn-outline"><i class="fa fa-pencil"></i> Edit</a>
                </div>
            </div>
            <div class="panel-body">
                <table class="table table-condensed table-striped " style="border: none;">
                    ...
                    <tr>
                        <td><?php echo e($dataangka->nama); ?></td>
                    </tr>
