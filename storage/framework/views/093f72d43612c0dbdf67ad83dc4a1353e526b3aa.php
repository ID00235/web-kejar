...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content-box-large">
  				<div class="panel-heading">
					...
					<div class="panel-options">
						<a href="<?php echo e(URL::to("admin/referensi/jenisinformasi/create")); ?>" data-rel="reload" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Buat Baru</a>
					</div>
				</div>
  				<div class="panel-body">
		              ...
		              <tbody>
		              	<?php
		                	$no=0;
		                ?>
		                <?php foreach($jenisinformasi as $jn): ?>
		                <?php
		                	$no++;
		                	$id = $jn->id;
		                ...
		                ?>
		                	<tr>
		                		...
		                		<td align="center">
		                			<a href="<?php echo e(URL::to("admin/referensi/jenisinformasi/edit/$cid")); ?>" class="btn btn-xs btn-success" title="Edit"><i class="fa fa-pencil"></i></a>
		                			<?php if($jdk>0): ?>
    ...
    <form action="<?php echo e(URL::to('admin/referensi/jenisinformasi/delete')); ?>" method="post" id="form-delete">
