    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title"><i class="fa fa-bank"></i> Edit Informasi Prosedur Layanan</div>
            ...
            ?>
                <form action="<?php echo e(URL::to('admin/prosedur/update/'.Crypt::encrypt($record->id))); ?>" method="POST">
