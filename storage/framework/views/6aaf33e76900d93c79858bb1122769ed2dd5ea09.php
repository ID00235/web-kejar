        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/berita")); ?>" data-rel="reload" class="btn btn-default btn-outline btn-sm"><i class="fa fa-angle-left"></i> Ke Index Berita</a>
                  <a href="<?php echo e(URL::to("admin/berita/edit/".$record->gethashid())); ?>" data-rel="reload" class="btn btn-success btn-outline btn-sm"><i class="fa fa-pencil"></i> Edit</a>
                </div>
            </div>
