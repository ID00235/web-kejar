    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title">Edit Berita</div>
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/berita/")); ?>" data-rel="reload" class="btn btn-outline btn-default btn-sm"><i class="fa fa-angle-left"></i> Index Berita</a>
                </div>
            </div>
