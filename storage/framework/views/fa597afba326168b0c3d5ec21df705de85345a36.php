    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title"><i class="fa fa-bank"></i> Profil PPID</div>
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/profil/baru")); ?>" data-rel="reload" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambahkan</a>
                </div>
            </div>
                ...
                <table id="tabel1" class="table table-striped table-condensed table-hover">
		              ...
		              <?php $no=0;?>
		              		<?php foreach($profil as $row): ?>
		              			...
		              			<tr>
		              				<td><?php echo e($no); ?></td>
		              				<td><a href="<?php echo e(URL::to('admin/profil/detail/'.$row->gethashid())); ?>"><?php echo e($row->nama); ?></a></td>
		              				<td>
		              					<a href="<?php echo e(URL::to("admin/profil/edit/".$row->gethashid())); ?>" class="btn btn-xs btn-success" title="Edit"><i class="fa fa-pencil"></i></a>
