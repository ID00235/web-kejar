    ...
    <div class="col-md-12">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title"><i class="fa fa-plus"></i> Entri Pengumuman</div>
            ...
            ?>
                <form action="<?php echo e(URL::to('admin/pengumuman/store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="col-md-12">
                                <div class="form-group <?php if($errors->has('gambar')): ?> has-error <?php endif; ?>">
                                    <label>Pilih File Gambar (Optional) <small>*Resolusi disarankan 600x400 pixel</small></label>
