    ...
    <div class="col-md-12">
        <div class="content-box-large">
            ...
            <div class="panel-body">
            	<a href="<?php echo e(URL::to("admin/berita/baru")); ?>" data-rel="reload" class="btn btn-primary btn-sm btn-outline"><i class="fa fa-plus"></i> Berita Baru</a>
		              ...
		              <?php $no=0;?>
		              		<?php foreach($berita as $row): ?>
		              			...
		              			<tr>
		              				...
		              				<td>
		              					<a href="<?php echo e(URL::to("admin/berita/edit/".$row->gethashid())); ?>" class="btn btn-sm btn-outline btn-success" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
		              					<button href="#" data-id="<?php echo e($row->gethashid()); ?>" data-judul="<?php echo e($row->judul); ?>" class="btn-del btn  btn-sm btn-outline btn-danger" title="Hapus"><i class="fa fa-times"></i> Hapus</button>
		              				</td>
		              			</tr>
		              		<?php endforeach; ?>
		              </tbody>
