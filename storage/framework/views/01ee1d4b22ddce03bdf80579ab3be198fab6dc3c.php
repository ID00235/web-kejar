        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/prosedur")); ?>" data-rel="reload" class="btn btn-default btn-sm"><i class="fa fa-angle-left"></i> Ke Index Prosedur</a>
                  <a href="<?php echo e(URL::to("admin/prosedur/edit/".$prosedur->gethashid())); ?>" data-rel="reload" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i> Edit</a>
                </div>
            </div>
            <div class="panel-body">
                <table class="table table-condensed table-striped " style="border: none;">
                    ...
                    <tr>
                        <td><?php echo e($prosedur->nama); ?></td>
                    </tr>
...
<form action="<?php echo e(URL::to('admin/dip/fileprosedur/delete')); ?>" method="post" id="form-delete">
