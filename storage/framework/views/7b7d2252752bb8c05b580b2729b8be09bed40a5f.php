        ...
        <div class="content-box-large">
            <div class="panel-heading">
                ...
                <div class="panel-options">
                  <a href="<?php echo e(URL::to("admin/prosedur/baru")); ?>" data-rel="reload" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambahkan</a>
                </div>
            </div>
            <div class="panel-body">
                <table id="tabel1" class="table table-striped table-condensed table-hover">
		              ...
		              <tbody>
		              <?php $no=0;?>
		              		<?php foreach($prosedur as $row): ?>
		              			<?php  $no++;?>
		              			<tr>
		              				<td><?php echo e($no); ?></td>
		              				<td><a href="<?php echo e(URL::to('admin/prosedur/detail/'.$row->gethashid())); ?>"><?php echo e($row->nama); ?></a></td>
		              				<td>
		              					<a href="<?php echo e(URL::to("admin/prosedur/edit/".$row->gethashid())); ?>" class="btn btn-xs btn-success" title="Edit"><i class="fa fa-pencil"></i></a>
...
<form action="<?php echo e(URL::to('admin/prosedur/delete')); ?>" method="post" id="form-delete">
