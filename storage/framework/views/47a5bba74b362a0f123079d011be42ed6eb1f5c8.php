...
<head>
    ...
    <title>Login PPID Dashboard</title>
        ...
        <div class="col-md-12 col-xs-12">
            <center>
               <form action="<?php echo e(URL::to('login/submitlogin')); ?>" method="post" name="Login_Form" class="one-edge-shadow form-signin">
                <div class="ribbon-wrapper ribbon-red">
              ...
              <div class="form-group">
                    ...
                    <small class="text-danger" >Kode Captcha Salah</small> <?php endif; ?>
                    <input type="text" class="form-control" required name="captcha" placeholder="Masukan Kode Captcha Diatas!" />
                </div>
